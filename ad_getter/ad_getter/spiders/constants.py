...
PRODUCT_ROUTES = '(collection|product|\w*\-?[ck]atalog|sankt-peterburg|shiny|diski|[e]?shop|store|item|model|magazin|products' \
    '|brendy|vse-tovary|tire|disk|prodazha|goods|market|ru)'
EXTRA_ROUTES = '(/[\w\-%\=\.]+/?)+'
